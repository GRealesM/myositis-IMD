...
```{r eval=FALSE}
ggsave(file="../figures/202111_Nov21/Basis_heatmap_r.svg", plot=bp, width=12, height=12)
```
...
```{r eval = FALSE}
ggsave(file="../figures/202111_Nov21/Myo_heatmap_r.svg", plot=my, width=12, height=12)
ggsave(file="../figures/202111_Nov21/Myo_heatmap_r.png", plot=my, width=12, height=12)
```
