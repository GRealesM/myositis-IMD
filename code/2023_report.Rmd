...
cts <- coloc[H4 > 0.5, .(driver.rsid, driver.nearestgene, bestsnp.rsid, trait.myos, trait.other, pairwise_fdr, H4, pbest.myos, pbest.myos.region, bestsnp.novel )][order(driver.nearestgene, bestsnp.rsid)]
cts[, .(H4 = max(H4), bestsnp.rsid), by=driver.rsid]
cts <- cts[, .(driver.rsid, driver.nearestgene, bestsnp.rsid, bestsnp.novel, pbest.myos, trait.myos,trait.other, pairwise_fdr, H4)][order(driver.nearestgene, trait.myos, trait.other)]
