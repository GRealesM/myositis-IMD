...
coloc[H4 > 0.5, .(pid, bestsnp.novel)] %>% unique %>% .[complete.cases(.)] # 7

```


At the H4 > 0.5 level, we found 33 associations and 8 associated candidate SNPs, 7 of them novel for myositis and its subtypes. These associations included polymyositis with hyperthyroidism, JIA, MPO+AAV, and myastenia gravis, and pooled myositis with hypo- and hyperthyroidism, JIA, MPO+AAV, myastenia gravis, PBC, Sjögren's syndrome and systemic sclerosis. 


```{r }

coloc[ H4 > 0.8 & bestsnp.novel == "Yes", .(mlabel, trait.other, pid, driver.rsid, driver.nearestgene, H4, bestsnp.rsid, bestsnp.pp, bestsnp.nearestgene, bestsnp.novel)][order(mlabel, trait.other, bestsnp)] %>% kable(digits = 32) %>% kable_styling
