...
# Save results
fwrite(index, "../tables/coloc_results_dfilt-v2.tsv", sep="\t") # This v2 should be the same as the previous version, just with the original p-values, rather than our own calculation
