...
system("zcat 20002_1225_PanUKBB_PanUKBBR2_1.bgz > 20002_1225_PanUKBB_1.tsv ; gzip 20002_1225_PanUKBB_1.tsv.gz")

f <- fread("20002_1225_PanUKBB_1.tsv.gz")
...
# Save it
fwrite(f, "20002_1225_PanUKBB_1-hr.tsv.gz", sep = "\t")

# Pipeline it 
system("~/rds/rds-cew54-basis/GWAS_tools/01-Pipeline/pipeline_v5.3.2_beta.sh -f 20002_1225_PanUKBB_1-hr.tsv.gz")
