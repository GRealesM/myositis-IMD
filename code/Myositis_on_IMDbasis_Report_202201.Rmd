...
metadata <- fread("../data/Metadata_20211126-v1.tsv")
...
PT.sel[, shorttrait:=ifelse(First_Author %in% c("Neale","PanUKBB"), Trait_long, Trait)][, shorttrait:=shorten_names(shorttrait)] # Create a shorttrait column and apply function. PanUKBB + Neale version
...
ggsave("../figures/202111_Nov21/Ladder_plot_PC12.png", forest.plots[["PC12"]], units = "mm", width = 180, height = 180, dpi = 300, bg="white")
ggsave("../figures/202111_Nov21/Ladder_plot_PC13.png", forest.plots[["PC13"]], units = "mm", width = 180, height = 260, dpi = 300, bg="white")
```
...
# 665 traits is a lot! Let's remove more and see
...
# 615 traits. Still a lot, but let's move forward with this
...
```{r eval= FALSE}
save_pheatmap_png(hmred, filename = "../figures/202111_Nov21/Redsig_heatmap_v1.png", width = 1500, height = 9000)
```
...
Save the plots
```{r eval=FALSE}
ggsave("../figures/202111_Nov21/Redviz_Ladder_plot_PC1.png", forest.plots[["PC1"]], units = "mm", width = 300, height = 800, dpi = 300, bg="white")
ggsave("../figures/202111_Nov21/Redviz_Ladder_plot_PC2.png", forest.plots[["PC2"]], units = "mm", width = 300, height = 500, dpi = 300, bg="white")
ggsave("../figures/202111_Nov21/Redviz_Ladder_plot_PC3.png", forest.plots[["PC3"]], units = "mm", width = 300, height = 750, dpi = 300, bg="white")
ggsave("../figures/202111_Nov21/Redviz_Ladder_plot_PC8.png", forest.plots[["PC8"]], units = "mm", width = 300, height = 450, dpi = 300, bg="white")
ggsave("../figures/202111_Nov21/Redviz_Ladder_plot_PC9.png", forest.plots[["PC9"]], units = "mm", width = 300, height = 300, dpi = 300, bg="white")
ggsave("../figures/202111_Nov21/Redviz_Ladder_plot_PC12.png", forest.plots[["PC12"]], units = "mm", width = 300, height = 550, dpi = 300, bg="white")
ggsave("../figures/202111_Nov21/Redviz_Ladder_plot_PC13.png", forest.plots[["PC13"]], units = "mm", width = 300, height = 1000, dpi = 300, bg="white")
```
